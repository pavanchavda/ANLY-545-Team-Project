...
####For this section, I could not filetr year...

ggplot(pp,aes(gunviolence$year, gunviolence$n_injured)) +
  geom_col()
...
ggplot(gunviolence, aes(gunviolence$year, gunviolence$n_killed)) +
  geom_col()

###killed by quarter

ggplot(gunviolence, aes(gunviolence$quarter, gunviolence$n_killed)) +
  geom_col()

####Killed by month

ggplot(gunviolence, aes(gunviolence$month, gunviolence$n_killed)) + 
  geom_col()
